...
public class AlarmHistoryController implements Callback<List<AlarmHistoryResponse>> {
    ...
    public AlarmHistoryController(Context context, AlarmListenerInterface alarmListResponseListener) {
