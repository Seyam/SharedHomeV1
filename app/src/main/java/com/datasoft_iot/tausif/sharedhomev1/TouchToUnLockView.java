...
import com.datasoft_iot.tausif.sharedhomev1.activity.MainActivity;
import com.datasoft_iot.tausif.sharedhomev1.utils.DimenUtils;
...
public class TouchToUnLockView extends FrameLayout {
    ...
    private void init() {
        ...
        circleRadius = DimenUtils.dp2px(getContext(), 22) + 80;
            ...
            case MotionEvent.ACTION_DOWN:
                ...
                if (isInTouchUnlockArea(mDownMotionX, mDownMotionY)) {
                    ...
                    if(MainActivity.flag ==0) {
                        ...
                        mUnlockTips.setText(R.string.slide_up_to_arm);
                    }

                    if(MainActivity.flag ==1) {
                        mUnlockTips.setVisibility(VISIBLE);
                        mUnlockTips.setText(R.string.slide_up_to_disarm);
                    }
                    return true;
                }
                break;
                ...
                if (mIsMoving || isInTouchUnlockArea(mDownMotionX, mDownMotionY)) {
                    ...
                    if (mTouchState == TOUCH_STATE_SCROLLING) {
                        ...
                        if (moveDistance > (unlockDistance * 2 / 3)) {
                            if(MainActivity.flag ==0) {
                                mUnlockTips.setVisibility(VISIBLE);
                                mUnlockTips.setText(R.string.release_to_arm);
                            }

                            if(MainActivity.flag ==1) {
                                mUnlockTips.setVisibility(VISIBLE);
                                mUnlockTips.setText(R.string.
                                release_to_disarm);
                            }
                        } else {
